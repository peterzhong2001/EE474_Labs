...
// 1936889
// 07/13/2021
// This is the main program for Lab 2 task 2 part c. This program implements the traffic
// light state machine with 1 system on/off button, 1 pedestrian button, and 3 LEDs.
// This program is implemented with Timer 0A ISR.
...
unsigned char GetButton(unsigned char sw) {
  ...
  // return true when the button is pressed and the 2-second time is up
